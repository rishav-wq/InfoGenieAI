#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\ASUS\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.401\\out\\buildHook\\index.js').default({tool: 'serve', checkSum: '203594bedcad6c70cdacbfAgEXBkxWXlpVUAJWU1JVBVdbVwdW', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/ASUS/.vscode/extensions/wallabyjs.console-ninja-1.0.401/out/buildHook/index.js').then(m => m.default.default({tool: 'serve', checkSum: '203594bedcad6c70cdacbfAgEXBkxWXlpVUAJWU1JVBVdbVwdW', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
